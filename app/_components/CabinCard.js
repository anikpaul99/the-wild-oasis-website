...
/**
 * One cabin card for each cabin. Each cabin card will display the image of the cabin, the name of the cabin, maximum capacity for each cabin, price of the cabin per night, and a link to know more detail and reservation.
 * @returns {JSX.Element}
 * @author Anik Paul
 */
